...
CREATE OR REFRESH MATERIALIZED VIEW elexon_app_for_settlement_acc_catalog.capitec_fraud_aml_gold.entity_network AS
...
FROM elexon_app_for_settlement_acc_catalog.capitec_fraud_aml_silver.accounts a
...
FROM elexon_app_for_settlement_acc_catalog.capitec_fraud_aml_silver.beneficial_ownership bo
...
LEFT JOIN elexon_app_for_settlement_acc_catalog.capitec_fraud_aml_silver.entity_map em2
