...
CREATE OR REFRESH MATERIALIZED VIEW elexon_app_for_settlement_acc_catalog.capitec_fraud_aml_silver.beneficial_ownership (
...
SELECT * FROM elexon_app_for_settlement_acc_catalog.capitec_fraud_aml_bronze.beneficial_ownership;
