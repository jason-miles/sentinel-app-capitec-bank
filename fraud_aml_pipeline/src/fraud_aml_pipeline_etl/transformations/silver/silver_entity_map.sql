...
CREATE OR REFRESH MATERIALIZED VIEW elexon_app_for_settlement_acc_catalog.capitec_fraud_aml_silver.entity_map (
...
FROM elexon_app_for_settlement_acc_catalog.capitec_fraud_aml_silver.entities;
