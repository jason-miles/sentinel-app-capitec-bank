...
--   .../capitec_fraud_aml_bronze/landing/card_transactions/
...
-- capitec_fraud_aml_bronze.card_transactions; silver.card_transactions unions the
...
CREATE OR REFRESH STREAMING TABLE
  elexon_app_for_settlement_acc_catalog.capitec_fraud_aml_bronze.card_transactions_stream
...
FROM STREAM read_files(
  '/Volumes/elexon_app_for_settlement_acc_catalog/capitec_fraud_aml_bronze/landing/card_transactions',
  format        => 'json',
