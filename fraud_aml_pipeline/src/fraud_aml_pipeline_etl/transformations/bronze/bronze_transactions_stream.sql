...
--   elexon_app_for_settlement_acc_catalog.capitec_fraud_aml_bronze.landing/transactions/
...
-- capitec_fraud_aml_bronze.transactions (2.4M seeded rows); silver.transactions
...
CREATE OR REFRESH STREAMING TABLE
  elexon_app_for_settlement_acc_catalog.capitec_fraud_aml_bronze.transactions_stream
...
FROM STREAM read_files(
  '/Volumes/elexon_app_for_settlement_acc_catalog/capitec_fraud_aml_bronze/landing/transactions',
  format        => 'json',
