...
# MAGIC %md
# MAGIC # Capitec Sentinel — SAR-propensity model: train + register + score (serverless driver)
...
mlflow.set_experiment("/Users/jason.miles@databricks.com/capitec_sentinel_sar_model")
