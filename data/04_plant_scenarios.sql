...
-- ═══════════════════════════════════════════════════════════════════════════
-- Synthetic subjects on Global One retail accounts.
INSERT INTO capitec_fraud_aml_bronze.customers
...
INSERT INTO capitec_fraud_aml_bronze.accounts VALUES
  ('ACCFRAUD01','CUSTFRAUD01','global_one_transact','ZAR', TIMESTAMP'2020-01-06 09:00:00','active', cast(date_sub(current_date(),1) AS TIMESTAMP), 82000.00,'crm', current_timestamp()),
  ('ACCFRAUD02','CUSTFRAUD02','global_one_transact','ZAR', TIMESTAMP'2019-06-16 09:00:00','active', cast(date_sub(current_date(),1) AS TIMESTAMP), 54000.00,'crm', current_timestamp()),
  ('ACCFRAUD03','CUSTFRAUD03','global_one_transact','ZAR', TIMESTAMP'2018-02-21 09:00:00','active', cast(date_sub(current_date(),1) AS TIMESTAMP), 31000.00,'crm', current_timestamp()),
  ('ACCFRAUD04','CUSTFRAUD04','global_one_transact','ZAR', TIMESTAMP'2021-09-02 09:00:00','active', cast(date_sub(current_date(),1) AS TIMESTAMP), 27500.00,'crm', current_timestamp()),
  -- passthrough (rapid movement) mule account
  ('ACCFRAUD05','CUSTFRAUD05','global_one_transact','ZAR', TIMESTAMP'2020-07-12 09:00:00','active', cast(date_sub(current_date(),1) AS TIMESTAMP), 9000.00,'crm', current_timestamp()),
  ...
  -- ATO target account
  ('ACCATO01','CUSTFRAUD04','global_one_transact','ZAR', TIMESTAMP'2021-09-02 09:00:00','active', cast(date_sub(current_date(),2) AS TIMESTAMP), 41000.00,'crm', current_timestamp());
...
INSERT INTO capitec_fraud_aml_bronze.third_parties VALUES
...
INSERT INTO capitec_fraud_aml_bronze.transactions
...
INSERT INTO capitec_fraud_aml_bronze.risk_ratings VALUES
...
INSERT INTO capitec_fraud_aml_bronze.beneficial_ownership VALUES
...
INSERT INTO capitec_fraud_aml_bronze.auth_events VALUES
...
INSERT INTO capitec_fraud_aml_bronze.card_transactions
...
INSERT INTO capitec_fraud_aml_bronze.accounts VALUES
  ...
  ('ACCMULE01','CUSTMULE01','global_one_transact','ZAR', cast(date_sub(current_date(),35) AS TIMESTAMP),'active', cast(date_sub(current_date(),1) AS TIMESTAMP), 1200.00,'crm', current_timestamp()),
  ('ACCMULE02','CUSTMULE02','global_one_transact','ZAR', cast(date_sub(current_date(),33) AS TIMESTAMP),'active', cast(date_sub(current_date(),1) AS TIMESTAMP), 900.00,'crm', current_timestamp()),
  ('ACCMULE03','CUSTMULE03','global_one_transact','ZAR', cast(date_sub(current_date(),31) AS TIMESTAMP),'active', cast(date_sub(current_date(),1) AS TIMESTAMP), 1500.00,'crm', current_timestamp()),
  ('ACCMULE04','CUSTMULE04','global_one_transact','ZAR', cast(date_sub(current_date(),29) AS TIMESTAMP),'active', cast(date_sub(current_date(),1) AS TIMESTAMP), 800.00,'crm', current_timestamp()),
  ('ACCMULE05','CUSTMULE05','global_one_transact','ZAR', cast(date_sub(current_date(),27) AS TIMESTAMP),'active', cast(date_sub(current_date(),1) AS TIMESTAMP), 1100.00,'crm', current_timestamp()),
  ('ACCMULE06','CUSTMULE06','global_one_transact','ZAR', cast(date_sub(current_date(),25) AS TIMESTAMP),'active', cast(date_sub(current_date(),1) AS TIMESTAMP), 950.00,'crm', current_timestamp()),
  ('ACCMULE07','CUSTMULE07','global_one_transact','ZAR', cast(date_sub(current_date(),24) AS TIMESTAMP),'active', cast(date_sub(current_date(),1) AS TIMESTAMP), 1300.00,'crm', current_timestamp());
...
INSERT INTO capitec_fraud_aml_bronze.accounts VALUES
  ...
  ('ACCGAME02','CUSTGAME02','global_one_transact','ZAR', cast(date_sub(current_date(),380) AS TIMESTAMP),'active', cast(date_sub(current_date(),1) AS TIMESTAMP), 38000.00,'crm', current_timestamp());
...
INSERT INTO capitec_fraud_aml_bronze.accounts VALUES
  ...
  ('ACCDUP03','CUSTDUP03','global_one_transact','ZAR', cast(date_sub(current_date(),300) AS TIMESTAMP),'active', cast(date_sub(current_date(),1) AS TIMESTAMP), 26000.00,'crm', current_timestamp());
