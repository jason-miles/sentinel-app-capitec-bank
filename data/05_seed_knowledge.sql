...
SELECT * FROM VALUES
  ...
  ('ESC-001','escalation_matrix','Alert Escalation Matrix','internal',
   ...
   'Capitec Escalation Matrix (synthetic)', current_timestamp()),
