# Capitec Sentinel — Live Demo Walkthrough (≈ 6.5 min)

**App:** https://capitec-sentinel-7474654808133980.aws.databricksapps.com
**Audience:** Capitec data/platform + financial-crime. **Goal:** show the full AML
...
### 0 · Hook (0:30)
> "This is Capitec Sentinel — a working AML platform on Databricks. Everything you'll
