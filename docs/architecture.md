# Capitec Sentinel — Architecture Overview
...
```
 ...
 └───────────────────────────────┬───────────────────────────────────────────────┘
   ...
   "Capitec Sentinel"      "Fraud & AML Analyst"    fraud_aml_daily_report
...
**Databricks App "Capitec Sentinel"** — React + FastAPI, served as a single process (all
...
app/backend/         FastAPI + React (Capitec Sentinel Databricks App) + tests/ + frontend/e2e/
