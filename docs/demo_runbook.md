# Capitec Sentinel — Demo Runbook

**App:** https://capitec-sentinel-7474654808133980.aws.databricksapps.com
**Audience:** Capitec Wealth & Banking (SQL-skilled team) + ICIB stakeholders
...
- [ ] App is RUNNING: `databricks apps get capitec-sentinel --profile fevm-elexon-app-for-settlement-acc`
...
**Show:** the landing page — Capitec | Sentinel hero, 90% / 50% / $10M+ band, two entry cards.
**Say:** "Sentinel is Capitec's CDP and financial-crime intelligence platform on Databricks.
