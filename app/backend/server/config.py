"""Dual-mode auth + workspace client for the Capitec Fraud & AML app.
...
GOLD_SCHEMA = os.environ.get("FRAUD_GOLD_SCHEMA", "capitec_fraud_aml_gold")
SILVER_SCHEMA = os.environ.get("FRAUD_SILVER_SCHEMA", "capitec_fraud_aml_silver")
