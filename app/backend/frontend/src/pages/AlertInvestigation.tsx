...
// Capitec tonal palette: deep-blue shades + signature red + muted blue-grey.
const SCEN_COLORS: Record<string, string> = {
  "Cash Structuring Detection": "#003b5c", "Dormant Account Reactivation": "#0a5580",
  "Rapid Fund Movement": "#4a90b9", "Related Account Movement": "#e2001a",
  "Round Dollar Pattern": "#7fb3d1", "PEP/Sanctions Alert": "#b42318",
  "High-Risk Geography Transfer": "#b54708", "Beneficiary Mismatch": "#5b6b78",
  "Third-Party Deposit Pattern": "#aecbde",
};
