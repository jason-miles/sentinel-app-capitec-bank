...
CREATE OR REPLACE VIEW elexon_app_for_settlement_acc_catalog.capitec_fraud_aml_gold.v_high_severity_alerts AS
SELECT
  ...
  concat('https://capitec-fraud-aml-7474654808133980.aws.databricksapps.com/alerts/', fa.alert_id) AS app_link
...
CREATE OR REPLACE VIEW elexon_app_for_settlement_acc_catalog.capitec_fraud_aml_gold.v_weekly_report AS
SELECT
  alert_type,
...
FROM elexon_app_for_settlement_acc_catalog.capitec_fraud_aml_gold.fraud_alerts
