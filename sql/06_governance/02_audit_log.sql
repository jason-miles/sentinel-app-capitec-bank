-- Capitec Sentinel — bank-grade governance: defensible audit trail (NEXT_STEPS #5).
--
...
CREATE TABLE IF NOT EXISTS capitec_fraud_aml_gold.audit_log (
  event_id      STRING,
  event_ts      TIMESTAMP,
...
-- GRANT SELECT, MODIFY ON TABLE capitec_fraud_aml_gold.audit_log
