...
CREATE OR REPLACE VIEW capitec_fraud_aml_gold.peer_anomaly AS
WITH per_customer AS (
  ...
  FROM capitec_fraud_aml_silver.accounts a
  LEFT JOIN capitec_fraud_aml_silver.transactions t
