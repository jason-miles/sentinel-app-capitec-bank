...
CREATE OR REPLACE VIEW elexon_app_for_settlement_acc_catalog.capitec_fraud_aml_gold.mv_fraud_alerts
WITH METRICS
LANGUAGE YAML
COMMENT 'Semantic metric view over fraud_alerts for Genie and reporting.'
AS $$
version: 0.1
source: elexon_app_for_settlement_acc_catalog.capitec_fraud_aml_gold.fraud_alerts
dimensions:
  - name: Alert Type
    expr: alert_type
  - name: Severity
