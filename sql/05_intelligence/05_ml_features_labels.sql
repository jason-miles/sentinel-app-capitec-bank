-- Capitec Sentinel — Supervised ML: feature + label tables (NEXT_STEPS #2).
--
...
--   catalog elexon_app_for_settlement_acc_catalog, schema capitec_fraud_aml_gold

USE CATALOG elexon_app_for_settlement_acc_catalog;
USE SCHEMA capitec_fraud_aml_gold;
