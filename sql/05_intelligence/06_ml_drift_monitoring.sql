-- Capitec Sentinel — ML drift monitoring (NEXT_STEPS #2, "drift monitoring").
--
...
CREATE OR REPLACE TABLE capitec_fraud_aml_gold.ml_drift_metrics AS
WITH cur AS (
...
FROM capitec_fraud_aml_gold.ml_feature_baseline b
